...
public class Patient {
	...
	public boolean equals(Object o) {
		...
		return id == patient.id && actif == patient.actif && nouveauPatient == patient.nouveauPatient
				&& rappelSms == patient.rappelSms && rappelMail == patient.rappelMail
				&& Objects.equals(numeroSs, patient.numeroSs) && Objects.equals(profession, patient.profession)
				&& Objects.equals(photo, patient.photo)
				&& Objects.equals(fichierAutorisationPhoto, patient.fichierAutorisationPhoto)
				&& Objects.equals(poids, patient.poids) && Objects.equals(taille, patient.taille)
				...
				&& Objects.equals(finDroit, patient.finDroit) && Objects.equals(fin100, patient.fin100)
				...
				&& Objects.equals(identifiant, patient.identifiant) && Objects.equals(motdepasse, patient.motdepasse)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, numeroSs, profession, photo, fichierAutorisationPhoto, poids, taille, nomJeuneFille,
				actif, relationPersonneAttachee, dateRenouvellementDep, dateModif, nouveauPatient, typeEcheanceId,
				modeReglementId, rangNaissance, rangBeneficiaire, finDroit, fin100, dateDeces, dateProchainRdv,
				rappelSms, rappelMail, dateProchaineInterv, dateInstallation, statutDossier, identifiant, motdepasse,
				dossierStatut, teleobservance, extranetactif, premiereConnexion);
	}
