...
public class ValeurMesure {
    ...
    @ManyToOne
    @JoinColumn(name = "intervention_id", referencedColumnName = "id", nullable = false, insertable=false, updatable=false)
    ...
    @ManyToOne
    @JoinColumn(name = "mesure_id", referencedColumnName = "id", nullable = false, insertable=false, updatable=false)
    ...
    @ManyToOne
    @JoinColumn(name = "parc_materiel_id", referencedColumnName = "id", nullable = false, insertable=false, updatable=false)
