...
public class Prescription {
    ...
    private PrescriptionStatut prescriptionStatutByStatutId;
    private PrescriptionEtat prescriptionEtatByEtatId;
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id &&
                ...
                Objects.equals(forfaitId, that.forfaitId) &&
                ...
                Objects.equals(etatId, that.etatId) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, patientId, dossierId, prescripteurId, forfaitId, aFacturer, suspendu, facture, statutId, datePrescription, dateDebut, dateFin, accidentCauseParTiers, dateAccident, quantite, prixUnitaireTtc, prixLppTcc, soumisDep, dateEnvoiMedecin, dateRetourMedecin, dateEnvoiCaisse, dateRetourCaisse, accord, etatId, aRenouveller, renouvellementFait, commentaire);
    }
    ...
    public PrescriptionStatut getPrescriptionStatutByStatutId() {
        return prescriptionStatutByStatutId;
    }

    public void setPrescriptionStatutByStatutId(PrescriptionStatut prescriptionStatutByStatutId) {
        this.prescriptionStatutByStatutId = prescriptionStatutByStatutId;
    }

    @ManyToOne
    @JoinColumn(name = "etat_id", referencedColumnName = "id")
    public PrescriptionEtat getPrescriptionEtatByEtatId() {
        return prescriptionEtatByEtatId;
    }

    public void setPrescriptionEtatByEtatId(PrescriptionEtat prescriptionEtatByEtatId) {
        this.prescriptionEtatByEtatId = prescriptionEtatByEtatId;
    }
}
